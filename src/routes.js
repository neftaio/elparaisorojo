...
import AboutUsPage from './components/pages/StaticContent/AboutUsPage';
import HowBuyPage from './components/pages/StaticContent/HowBuyPage';
import ContactUsPage from './components/pages/StaticContent/ContactUsPage';
import ProductsSpecials from './components/pages/StaticContent/ProductsSpecials';
...
const routes = (
  ...
  <Route name="aboutus" handler={AboutUsPage} />
  <Route name="how-buy" handler={HowBuyPage} />
  <Route name="contact-us" handler={ContactUsPage} />
  <Route name="products-specials" handler={ProductsSpecials} />
