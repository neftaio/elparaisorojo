...
class DesktopHeader extends React.Component {
    ...
    render() {
        ...
        <div className="header-contact-title">
          ...
          <img src="/static/elparaisorojo-telefono-whatsapp-sexshop.jpg" className="header-phones"/> (317)6505861
</div>
        <div className="header-contact-phone">
          (304)6365718
</div>
        <div className="header-contact-email">
          <img src="/static/elparaisorojo-email-contactanos-sexshop.jpg" className="header-email"/> <span className="header-email-text">elparaisorojo.shop@gmail.com</span>
</div>
        </div>
      ...
      {/* ./Search button */}
                            <div className="desktop-header__cart" onClick={this.handleBtnClick.bind(null, 'cart')}>
                                ...
                                <i className="material-icons desktop-header__cart-icon">shopping_cart</i>
                            </div>
