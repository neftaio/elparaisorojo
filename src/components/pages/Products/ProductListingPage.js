...
class ProductListingPage extends React.Component {
  ...
  staticCarouselImagesProducts = () => {
    return [
      {src:'/static/elparaisorojo-masturbadores-sexshop-productos-tienda-erotica.jpg',
      link:'#',
      title:'Masturbadores',
      text:''},
      {src:'/static/elparaisorojo-juegos-eroticos-sexshop-productos-tienda-erotica.jpg',
      link:'#',
      title:'Juguetes Eróticos',
      text:'Porque el juego y el erotismo son una mezcla con resultados inesperadamente satisfactorios, ver aquí...'},
      {src:'/static/elparaisorojo-sado-sexshop-productos-tienda-erotica.jpg',
      link:'#',
      title:'Sado',
      text:'Porque los amos y sumisos merecen un lugar especial, descubre aquí...'},
      {src:'/static/elparaisorojo-bolas-chinas-sexshop-productos-tienda-erotica.jpg',
      link:'#',
      title:'Bolas chinas',
      text:'Ellas estan para sacar todo el fuego escondido dentro de nosotras de una manera tierna, delicada y discreta, mira aquí...'}
    ]
  }
        ...
        return (
          ...
          <div className="homepage__cta">
            <div className="homepage__banners">
              <Carousel images={this.staticCarouselImagesProducts()} />
            </div>
          </div>
